...
public class ApiClient {
    ...
    private String basePath = "http://127.0.0.1:8000/api/v1";
    ...
    public ApiClient() {
        ...
        authentications.put("MiWApiSecurity", new OAuth());
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://127.0.0.1:8000/api/v1
